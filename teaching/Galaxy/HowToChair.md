...
- 阅读每位报告人的报告标题与摘要，提前了解报告内容。
- 准备一个简洁清楚的**口头介绍**，最好用你自己的语言总结标题和关键词，而不是逐字照读会议手册。
- 了解该分会场所有报告的顺序。
- 提前几分钟到场，协助报告人进行投影、连接等设置。
- 提醒报告人报告时间，以及你将如何提醒时间（如举牌、手势、声音等）。
- **开场时务必自我介绍**（包括你的姓名和所在单位）。

### 🔹 二、主持报告环节

- 全程关注报告时间，准备计时工具。
- 在报告剩余 **3分钟** 和 **1分钟** 时进行提示。
- 时间结束时，如报告未结束，可**礼貌提醒或直接起身**示意。
- 若报告人严重超时，可适当中断并请其尽快结束，以保证会议节奏。
...
- 你的任务是**协助报告人与听众之间建立良好沟通**。
- 保持流程顺畅、节奏适当，**适时做出判断与调控**。
- 面对突发状况要保持冷静（例如技术问题、时间超时、听众插话等）。

---

> 本指南内容改写整理自**戴昱老师（Prof. Sophia Y. Dai）**为7th C-MaNGA workshop撰写的教程，谨此致谢她的精彩总结与慷慨分享。